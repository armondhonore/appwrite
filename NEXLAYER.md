# Nexlayer — appwrite-console

**Live:** [https://relaxed-weasel-appwrite-console.cloud.nexlayer.ai](https://relaxed-weasel-appwrite-console.cloud.nexlayer.ai)  

**Runtime:** node · **Port:** 3000 · **Deploy branch:** 1.9.x

---

## How this deployment works

**appwrite-console** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
platform where every push to `1.9.x` triggers a fully automated build-and-deploy
...
application:
  ...
  pods:
    - name: app
      image: "registry.nexlayer.io/user_01kece1xyh817dwff7wnarhkxd/appwrite:9f05a19-fix5"
      path: /
      servicePorts:
        - 3000
      vars: {}
...
Triggers on:
- **Push** to `1.9.x` → production redeploy
...
> `<podName>.pod:<port>` syntax. CI/CD runs on push to `1.9.x`."*
